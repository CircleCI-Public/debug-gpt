...
export const LangPicker = ({ onClose }: Props): JSX.Element => {
    ...
    <div className='container mx-auto text-neutral-900 h-screen bg-white'>
      <div className='flex flex-col items-center max-w-lg m-auto h-screen justify-center'>
        <h1 className='text-center text-neutral-900 text-2xl font-medium mb-5'>
          Select which language Debug-GPT should answer in:
        </h1>

        <select
          name='lang'
          className='w-full px-1 py-2 rounded border border-neutral-400'
          value={selectValue}
          onChange={(e): void => {
        ...
        <p className='text-neutral-400 mt-1 mb-2'>
          Note: OpenAI translations quality can vary depending on the complexity
          of your errors.
        </p>
