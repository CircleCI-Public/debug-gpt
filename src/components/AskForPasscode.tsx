...
return <div className="container mx-auto text-neutral-900 h-screen bg-white">
    <div className="flex flex-col items-center max-w-lg m-auto h-screen justify-center">
      <h1 className="text-center text-neutral-900 text-2xl font-medium mb-5">We need your passcode to securely use your OpenAI API Key</h1>

      <input className="w-full px-4 py-2 rounded border border-neutral-400" type="password" value={passcodeValue}  onChange={(e) => setPasscodeValue(e.target.value)} placeholder="Personal passcode" />
      ...
      <p onClick={reset} className="text-neutral-500 mt-1 underline cursor-pointer">I don't remember</p>
